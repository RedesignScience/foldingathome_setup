...
water_model = 'tip3p'
# first run with solvent padding, check maximum number of waters+salts added between structures, then re-run with that number
#solvent_padding = 10.0 * unit.angstroms
solvent_numAdded = 7000
ionic_strength = 150 * unit.millimolar
hydrogen_mass = 3.0 * unit.amu

# 4/35 runs are ending up with a different tautomer of HIS109 (0-index 108) -- 31 runs have HID so we're gonna force that for all
